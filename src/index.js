...
* <pre>
* var QcReadApi = require('index'); // See note below*.
* var xxxSvc = new QcReadApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new QcReadApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new QcReadApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new QcReadApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
