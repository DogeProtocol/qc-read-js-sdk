...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QcReadApi.AccountTransactionSummary();
  });
  ...
  describe('AccountTransactionSummary', function() {
    it('should create an instance of AccountTransactionSummary', function() {
      ...
      //var instance = new QcReadApi.AccountTransactionSummary();
      //expect(instance).to.be.a(QcReadApi.AccountTransactionSummary);
    });
