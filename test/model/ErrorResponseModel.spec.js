...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsReadApi.ErrorResponseModel();
  });
  ...
  describe('ErrorResponseModel', function() {
    it('should create an instance of ErrorResponseModel', function() {
      ...
      //var instance = new AccountsReadApi.ErrorResponseModel();
      //expect(instance).to.be.a(AccountsReadApi.ErrorResponseModel);
    });
