...
QcReadApi - JavaScript client for qc-read-js-sdk
...
```shell
npm install qc-read-js-sdk --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your qc-read-js-sdk from, and run:
