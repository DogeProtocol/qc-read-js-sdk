...
QcReadApi - JavaScript client for qc-read-sdk
...
To use the link you just defined in your project, switch to the directory you want to use your qc-read-sdk from, and run:
...
```javascript
var QcReadApi = require('qc-read-sdk');
